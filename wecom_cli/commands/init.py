...
from wecom_cli.core.config import load_config, save_config, STATE_DIR, KEYS_FILE
from wecom_cli.output.formatter import output_json, output_text
...
def init(db_dir, force, corp_id):
    ...
    try:
        ...
        # Extract keys
        from wecom_cli.keys import extract_keys
